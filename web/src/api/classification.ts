...
enum URL {
    userList = '/shopserver/classification/list',
    create = '/shopserver/classification/create',
    update = '/shopserver/classification/update',
    delete = '/shopserver/classification/delete',
}
